...
{
    rpg->menu->stg->graph->graph_btn->graphismes = malloc(sizeof(sfSprite *) * 8);
...
void init_bt_opt(rpg_t *rpg)
{
    ...
    sfSprite_setPosition(rpg->menu->stg->graph->graph_btn->graphismes[RES19x80], res_19x80);
    sfSprite_setPosition(rpg->menu->stg->graph->graph_btn->graphismes[RES12x20], res_12x20);
    sfSprite_setPosition(rpg->menu->stg->graph->graph_btn->graphismes[RES11x30], res_11x30);
    sfSprite_setPosition(rpg->menu->stg->graph->graph_btn->graphismes[FPS30], fps_30);
    sfSprite_setPosition(rpg->menu->stg->graph->graph_btn->graphismes[FPS60], fps_60);
    sfSprite_setPosition(rpg->menu->stg->graph->graph_btn->graphismes[CIRCLE_MUSIC], music);
    sfSprite_setPosition(rpg->menu->stg->graph->graph_btn->graphismes[CIRCLE_AMBT], ambiant);
    sfSprite_setPosition(rpg->menu->stg->graph->graph_btn->graphismes[CIRCLE_DIAG], diag);
}
...
void sound_cirle(rpg_t *rpg)
{
    ...
    rpg->menu->stg->graph->graph_btn->graphismes[CIRCLE_MUSIC] = sfSprite_create();
    sfSprite_setTexture(rpg->menu->stg->graph->graph_btn->graphismes[CIRCLE_MUSIC],
    circle, sfTrue);
