...
void drop_weapons(rpg_t *rpg)
{
    ...
    rpg->game->in_game->inventory->box_pos[18][0].x)) &&
    ((rpg->basic->cnf->mouse.y) >= adapt_y(rpg,
    rpg->game->in_game->inventory->box_pos[18][0].y)) &&
    (rpg->basic->cnf->mouse.x <= adapt_x(rpg,
    rpg->game->in_game->inventory->box_pos[18][1].x)) &&
    (rpg->basic->cnf->mouse.y <= adapt_y(rpg,
    rpg->game->in_game->inventory->box_pos[18][1].y))) {
        rpg->game->in_game->inventory->pos_weapon
        [rpg->game->in_game->inventory->selected_item] = put_in_vector2f(
        (float)rpg->game->in_game->inventory->box_pos[18][0].x,
        (float)rpg->game->in_game->inventory->box_pos[18][0].y);
    }
}
...
void drop_bullets(rpg_t *rpg)
{
    ...
    ((rpg->basic->cnf->mouse.x) >= adapt_x(rpg,
    rpg->game->in_game->inventory->box_pos[19][0].x)) &&
    ((rpg->basic->cnf->mouse.y) >= adapt_y(rpg,
    rpg->game->in_game->inventory->box_pos[19][0].y)) &&
    (rpg->basic->cnf->mouse.x <= adapt_x(rpg,
    rpg->game->in_game->inventory->box_pos[19][1].x)) &&
    (rpg->basic->cnf->mouse.y <= adapt_y(rpg,
    rpg->game->in_game->inventory->box_pos[19][1].y))) {
        rpg->game->in_game->inventory->pos_weapon
        [rpg->game->in_game->inventory->selected_item] = put_in_vector2f(
        (float)rpg->game->in_game->inventory->box_pos[19][0].x,
        (float)rpg->game->in_game->inventory->box_pos[19][0].y);
    }
}
...
void drop_bullet_proof(rpg_t *rpg)
{
    ...
    rpg->game->in_game->inventory->selected_item < NO_BULLET) &&
    ((rpg->basic->cnf->mouse.x) >= adapt_x(rpg,
    rpg->game->in_game->inventory->box_pos[20][0].x)) &&
    ((rpg->basic->cnf->mouse.y) >= adapt_y(rpg,
    rpg->game->in_game->inventory->box_pos[20][0].y)) &&
    (rpg->basic->cnf->mouse.x <= adapt_x(rpg,
    rpg->game->in_game->inventory->box_pos[20][1].x)) &&
    (rpg->basic->cnf->mouse.y <= adapt_y(rpg,
    rpg->game->in_game->inventory->box_pos[20][1].y))) {
        rpg->game->in_game->inventory->pos_weapon
        [rpg->game->in_game->inventory->selected_item] = put_in_vector2f(
        (float)rpg->game->in_game->inventory->box_pos[20][0].x,
        (float)rpg->game->in_game->inventory->box_pos[20][0].y);
    }
